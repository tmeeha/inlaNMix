...
syntax used in \pkg{unmarked} is a simple extension of the standard 
...
familiar model syntax and rapid model evaluation of \pkg{unmarked} has 
...
The \pkg{unmarked} analysis was run by a call to the \code{pcount()} 
...
\pkg{R-INLA}. The data frame has 239 sites $\times$ 1 year = 239 rows, one 
